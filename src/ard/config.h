...
// BMP280 (Barometer)
#define BMP_MODE BMP280_MODE_NORMAL
#define BMP_TEMP_OVERSAMPLING BMP280_SAMPLING_X2
#define BMP_PRESSURE_OVERSAMPLING BMP280_SAMPLING_X16
#define BMP_FILTER BMP280_FILTER_OFF
#define BMP_STANDBY_MS BMP280_STANDBY_MS_1000
